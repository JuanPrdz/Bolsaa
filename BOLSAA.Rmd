...
# Conclusión: 
Con la ayuda del var podemos tener conocimiento de cuanto es el maximo valor posible de perdida de nuetro portafolio para diferentes periodos de tiempo. Nos da una información vital a la hora de adquirir cirta acción o portafolio. 

Con todo este proyecto, pudimos analizar los diferente métodos y medidas que nos ayudan a estudiar el riesgo que con lleva adquirir algun activo financiero. Ya sea con suposiciones de normalidad o no. Fue muy interesante estudiar este activo debido a que aprendimos a verlo de otra manera mas alla de solo comprar o vender dependiendo de su gráfica. Ahora tenemos herramientas para elegir de manera optima los activos de nuestro portafolio, teniendo en cuenta el riesgo que conlleva. 

Tambien aprendimos a determinar precios, para uno o mas días con diferentes métodologias. Lo cual tambien podemos aplicar de ahora en adelante, día con cía en nuestros portafolios personales. 
